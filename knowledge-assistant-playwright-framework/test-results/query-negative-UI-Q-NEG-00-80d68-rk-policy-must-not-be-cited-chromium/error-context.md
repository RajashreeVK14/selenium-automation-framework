...
- Name: query-negative.spec.ts >> UI-Q-NEG-007: Retired remote work policy must not be cited
...
- generic [ref=e1]:
  ...
  - main [ref=e9]:
    - generic [ref=e10]:
      - generic [ref=e11]:
        - textbox "Ask a question, e.g. what is my meal allowance?" [ref=e12]: How many remote days were allowed under the old policy?
