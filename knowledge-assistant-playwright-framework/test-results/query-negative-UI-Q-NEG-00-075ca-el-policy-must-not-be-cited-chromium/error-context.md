...
- Name: query-negative.spec.ts >> UI-Q-NEG-006: APAC in-review travel policy must not be cited
...
- generic [ref=e1]:
  ...
  - main [ref=e9]:
    - generic [ref=e10]:
      - generic [ref=e11]:
        - textbox "Ask a question, e.g. what is my meal allowance?" [ref=e12]: What is the proposed APAC meal allowance in JPY?
        - button "Ask" [active] [ref=e13] [cursor=pointer]
      - generic [ref=e14]: The daily meal allowance for APAC travel is JPY 8000.
      - generic [ref=e16]: D-003
    - complementary [ref=e17]:
      - heading "Documents visible to you" [level=2] [ref=e18]
      - generic [ref=e20]:
        - generic [ref=e21]: Remote Work Policy
        - generic [ref=e22]: D-004 · Approved
```
